...
namespace _6502
{
    ...
    inline std::array<Instruction, 0x100> instruction_set
    {
        ...
        Instruction{0xC0, 2, 2, Mnemonic::CPY, AddressingMode::imm},
        Instruction{0xC1, 2, 6, Mnemonic::CMP, AddressingMode::Xind},
        Instruction{0xC2, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xC3, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xC4, 2, 3, Mnemonic::CPY, AddressingMode::zpg},
        Instruction{0xC5, 2, 3, Mnemonic::CMP, AddressingMode::zpg},
        Instruction{0xC6, 2, 5, Mnemonic::DEC, AddressingMode::zpg},
        Instruction{0xC7, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xC8, 0, 0, Mnemonic::INY, AddressingMode::impl},
        Instruction{0xC9, 2, 2, Mnemonic::CMP, AddressingMode::imm},
        Instruction{0xCA, 1, 2, Mnemonic::DEX, AddressingMode::impl},
        Instruction{0xCB, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xCC, 3, 4, Mnemonic::CPY, AddressingMode::abs},
        Instruction{0xCD, 3, 4, Mnemonic::CMP, AddressingMode::abs},
        Instruction{0xCE, 3, 6, Mnemonic::DEC, AddressingMode::abs},
        Instruction{0xCF, 0, 0, Mnemonic::none, AddressingMode::none},

        Instruction{0xD0, 2, 2, Mnemonic::BNE, AddressingMode::rel},
        Instruction{0xD1, 2, 5, Mnemonic::CMP, AddressingMode::indY},
        ...
        Instruction{0xD5, 2, 4, Mnemonic::CMP, AddressingMode::zpgX},
        Instruction{0xD6, 2, 6, Mnemonic::DEC, AddressingMode::zpgX},
        Instruction{0xD7, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xD8, 1, 2, Mnemonic::CLD, AddressingMode::impl},
        Instruction{0xD9, 3, 4, Mnemonic::CMP, AddressingMode::absY},
        ...
        Instruction{0xDD, 3, 4, Mnemonic::CMP, AddressingMode::absX},
        Instruction{0xDE, 3, 7, Mnemonic::DEC, AddressingMode::absX},
        Instruction{0xDF, 0, 0, Mnemonic::none, AddressingMode::none},

        Instruction{0xE0, 2, 2, Mnemonic::CPX, AddressingMode::imm},
        Instruction{0xE1, 2, 6, Mnemonic::SBC, AddressingMode::Xind},
        Instruction{0xE2, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xE3, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xE4, 2, 3, Mnemonic::CPX, AddressingMode::zpg},
        Instruction{0xE5, 2, 3, Mnemonic::SBC, AddressingMode::zpg},
        Instruction{0xE6, 2, 5, Mnemonic::INC, AddressingMode::zpg},
        Instruction{0xE7, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xE8, 1, 2, Mnemonic::INX, AddressingMode::impl},
        Instruction{0xE9, 2, 2, Mnemonic::SBC, AddressingMode::imm},
        Instruction{0xEA, 1, 2, Mnemonic::NOP, AddressingMode::impl},
        Instruction{0xEB, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xEC, 3, 4, Mnemonic::CPX, AddressingMode::abs},
        Instruction{0xED, 3, 4, Mnemonic::SBC, AddressingMode::abs},
        Instruction{0xEE, 3, 6, Mnemonic::INC, AddressingMode::abs},
        Instruction{0xEF, 0, 0, Mnemonic::none, AddressingMode::none},

        Instruction{0xF0, 2, 2, Mnemonic::BEQ, AddressingMode::rel},
        Instruction{0xF1, 2, 5, Mnemonic::SBC, AddressingMode::indY},
        ...
        Instruction{0xF5, 2, 4, Mnemonic::SBC, AddressingMode::zpgX},
        Instruction{0xF6, 2, 6, Mnemonic::INC, AddressingMode::zpgX},
        Instruction{0xF7, 0, 0, Mnemonic::none, AddressingMode::none},
        Instruction{0xF8, 1, 2, Mnemonic::SED, AddressingMode::impl},
        Instruction{0xF9, 3, 4, Mnemonic::SBC, AddressingMode::absY},
        ...
        Instruction{0xFD, 3, 4, Mnemonic::SBC, AddressingMode::absX},
        Instruction{0xFE, 3, 7, Mnemonic::INC, AddressingMode::absX},
